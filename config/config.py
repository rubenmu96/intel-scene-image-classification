...
class cfg:
    ...
    model = "resnet50" # supports resnet18, 34 and 50
    image_size = 224
    batch_size = 64
    num_epochs = 30
    learning_rate = 1e-5
    ...
    train_transform = A.Compose([
        ...
        A.ShiftScaleRotate(shift_limit=0.05, scale_limit=0.15, rotate_limit=0, p=0.25),
        A.RandomGamma(gamma_limit = (40, 60), p=0.25),
